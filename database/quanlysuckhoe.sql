...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2024 at 02:30 PM
...
(1, 'admin', '$2b$10$kxveS/MI7sYSQA38eSqf1OBBIxGy0nw6FFouT4OYTMq2dJAYIIaYO', 1),
...
INSERT INTO `thuoc` (`Id`, `TenThuoc`, `DonVi`) VALUES
(1, 'Paracetamol', 'mg'),
(2, 'Ibuprofen', 'mg'),
(3, 'Amoxicillin', 'mg'),
(4, 'Ciprofloxacin', 'mg'),
...
(11, 'Prednisone', 'mg'),
(12, 'Metoprolol', 'mg'),
(13, 'Levothyroxine', 'mcg'),
(14, 'Atorvastatin', 'mg'),
(15, 'Azithromycin', 'mg'),
(16, 'Clopidogrel', 'mg'),
(17, 'Cetirizine', 'mg'),
(18, 'Hydrochlorothiazide', 'mg'),
(19, 'Doxycycline', 'mg'),
(20, 'Insulin', 'IU'),
(21, 'Losartan', 'mg'),
(22, 'Gabapentin', 'mg'),
